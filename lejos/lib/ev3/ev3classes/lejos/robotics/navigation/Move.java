...
public class Move implements Transmittable {
  ...
  /**
   * Create a movement object to record a movement made by a pilot. This method automatically
   * calculates the MoveType based on the data as follows:<br>
   ...
   * but it can't represent a straight line of travel with a set distance (use the other constructor
   * to specify distance). This method automatically calculates the MoveType based on the data as
   * follows:<br>
   ...
   * <li>NOTE: can't calculate distance based only on angle and radius, therefore distance can't be
   *     calculated and will equal NaN)
   *
   * @param isMoving
   * @param angle
   * @param turnRadius
  ...
  /**
   * The time stamp is the system clock at the time the Move object is created. It is set
   * automatically in the Move constructor using {@link System#currentTimeMillis()}
   *
