...
public interface MoveController extends MoveProvider {
  ...
  /**
   * Sets the speed at which the robot will travel forward and backward (and to some extent arcs,
   * although actual arc speed is slightly less). Speed is measured in units/second. e.g. If wheel
   * diameter is cm, then speed is cm/sec.
   *
  ...
  /**
   * Returns the speed at which the robot will travel forward and backward (and to some extent arcs,
   * although actual arc speed is slightly less). Speed is measured in units/second. e.g. If wheel
   * diameter is cm, then speed is cm/sec.
   *
