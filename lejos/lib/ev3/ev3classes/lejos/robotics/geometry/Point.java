...
/**
 * Point with float co-ordinates for use in navigation. This class includes methods allow it to
 * behave as a vector in 2 dimensional vector space. It includes the standard vector arithmetic
 * operatins of addition, * subtraction, scalar multiplication, and inner product.
 *
...
public class Point extends Point2D.Float {
  ...
  /**
   * Finds the orthogonal projection of this point onto the line. The projection may lie on an
