...
public abstract class Line2D implements Shape, Cloneable {
  ...
  public boolean intersectsLine(Line2D l) {
    return linesIntersect(
        l.getX1(), l.getY1(), l.getX2(), l.getY2(), getX1(), getY1(), getX2(), getY2());
  }
   ...
   * @return 0 iff the point is on the line else 1 or -1 depending on whether the point in to the
   *     left or ahead of the line, or to the right or behind the line segment
   */
  ...
  /**
   * Measures the square of the shortest distance from the reference point to a point on the line
   * segment. If the point is on the segment, the result will be 0.
   *
  ...
  /**
   * Measures the shortest distance from the reference point to a point on the line segment. If the
   * point is on the segment, the result will be 0.
   *
   * @param x1 the first x coordinate of the segment
   * @param y1 the first y coordinate of the segment
   * @param x2 the second x coordinate of the segment
  ...
  /**
   * Measures the square of the shortest distance from the reference point to a point on this line
   * segment. If the point is on the segment, the result will be 0.
   *
   * @param px the x coordinate of the point
   * @param py the y coordinate of the point
  ...
  /**
   * Measures the shortest distance from the reference point to a point on this line segment. If the
   * point is on the segment, the result will be 0.
   *
   * @param px the x coordinate of the point
   * @param py the y coordinate of the point
