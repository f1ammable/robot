...
/**
 * This class returns a motor that rotates in the reverse direction of a regular motor. All
 * tachometer readings are also reversed.
 *
 * <p>Use the factory method MirrorMotor.invertMotor(RegulatedMotor) to retrieve an inverted motor.
 *
 * @author BB
 */
public class MirrorMotor implements RegulatedMotor, RegulatedMotorListener {
  ...
  public void rotationStarted(
    ...
    if (regListener != null) regListener.rotationStarted(this, -tachoCount, stalled, timeStamp);
  }

  public void rotationStopped(
      RegulatedMotor motor, int tachoCount, boolean stalled, long timeStamp) {
    if (regListener != null) regListener.rotationStopped(this, -tachoCount, stalled, timeStamp);
  }
