...
/**
 * NavigationModel is an abstract class that has two implementations: NXTNavigationModel and
 * PCNavigationModel.
 *
 * <p>It is used to hold all navigation data and transmit updates to the date and other events
 * between a NXT brick and the PC.
 *
 * <p>The abstract NAvigationModel class defines all the events and all data and methods that are
 * common to the NXT and PC implementations.
 *
 * <p>The purpose of NavigationModel and the NXT and PC implementations is to to allow navigation
 * tasks to be split between the NXT and the PC, to allow the PC to show a graphical display of the
 * navigational data and allow the user to interact with it.
 *
 * <p>This allows many different navigation applications to be developed which split processing
 * between the PC and the NXT.
 *
