...
/**
 * The RangeMap interface supports determining the range to a feature on the map (such as a wall),
 * from an object with a specific pose.
 *
 * <p>It also supports the a method to determine if a point is within the mapped area.
 *
