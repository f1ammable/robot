...
public class LineMap implements RangeMap, Transmittable {
  ...
  public boolean inside(Point p) {
    ...
    if (p.x > boundingRect.x + boundingRect.width || p.y > boundingRect.y + boundingRect.height)
      return false;
  ...
  public void loadObject(DataInputStream dis) throws IOException {
    ...
    boundingRect =
        new Rectangle(dis.readFloat(), dis.readFloat(), dis.readFloat(), dis.readFloat());
  }
