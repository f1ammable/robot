...
/**
 * This class loads map data from an SVG and produces a LineMap object, which can be used by the
 * leJOS navigation package.
 *
...
public class SVGMapLoader {
  ...
  public LineMap readLineMap() throws XMLStreamException {
    ...
    while (true) {
      ...
      if (event == XMLStreamConstants.END_DOCUMENT) {
        ...
        break;
          ...
          && parser.getLocalName().equals("line")) {
    ...
    return new LineMap(
            lines.toArray(new Line[lines.size()]),
