 ...
 *
 * @see <a href=http://en.wikipedia.org/wiki/Low-pass_filter>http://en.wikipedia.
...
public class LowPassFilter extends AbstractFilter {
   ...
   * Constructor
   *
   * @param source The source for getting samples
   * @param timeConstant The cut-off frequency for the filter
   */
   ...
   *
   * <p>See http://en.wikipedia.org/wiki/Low-pass_filter
   */
