...
public class LightDetectorAdaptor {
  /**
   * allocates a LightSensorAdaptor ; sets mode to Ambient Accepts as a parameter one of
   * EV3ColorSensor, NXTColorSensor, or NXTLightSensor
   */
  ...
  /**
   * @param useReflected if true, reflected mode will be used; otherwise the ambient mode will be
   *     used;
   */
  ...
  /**
   * call setHigh() and setLow() before using this method. returns 0.0 when measured light value is
   * low, 1.0 when it is high
   *
