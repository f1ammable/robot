...
public class FixedRangeScanner implements RangeScanner {
  ...
  /**
   * Return a set of range readings determined taken at the relative bearings defined in the angles
   * array; The robot rotates back to its original heading at the end.
   *
