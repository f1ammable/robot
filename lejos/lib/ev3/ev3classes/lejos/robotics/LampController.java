...
public interface LampController {
  // TODO: Possible names: LEDLightDetector (too specific), FloodlightDetector, FloodLightDetector,
  // FloodlightLightDetector.
  ...
  /**
   * Used to turn on or off the floodlight by color. If the sensor has multiple light colors, you
   * can control which color is turned on or off. If the color does not exist, it does nothing and
   * returns false. You can turn the floodlight off by using Color.NONE.
   *
