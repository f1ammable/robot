 ...
 * The gyroscope is sampled at a regular interval and its output is integrated into accumulated
 * angle.
 *
 * @author Aswin
 */
public class GyroscopeAdapter implements Gyroscope {
  ...
  /**
   * @param source A SampleProvider representing a gyroscope
   * @param sampleFrequency The frequency used to sample the gyroscope
   * @param axisIndex The axis to use (usefull with multiaxis gyroscopes
   */
