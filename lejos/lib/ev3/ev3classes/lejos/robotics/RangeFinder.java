...
public interface RangeFinder {
  ...
  /**
   * If the sensor is capable, this method returns multiple range values from a single scan. Sensors
   * that can only return a single value should return an array containing a single value.
   *
