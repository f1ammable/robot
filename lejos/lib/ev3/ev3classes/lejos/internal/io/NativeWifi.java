...
public class NativeWifi {
  ...
  public static class SockAddr extends Structure {
    ...
    protected List getFieldOrder() {
      ...
      return Arrays.asList(new String[] {"family", "bd_addr"});
    }
  }
  ...
  public static class Point extends Structure {
    ...
    protected List getFieldOrder() {
      // TODO Auto-generated method stub
      return Arrays.asList(new String[] {"p", "length", "flags"});
    }
  }
  ...
  public static class WReqSocket extends Structure implements Structure.ByReference {
    ...
    protected List getFieldOrder() {
      // TODO Auto-generated method stub
      return Arrays.asList(new String[] {"ifname", "sockaddr"});
    }
  }
  ...
  public static class WReqPoint extends Structure implements Structure.ByReference {
    ...
    protected List getFieldOrder() {
      // TODO Auto-generated method stub
      return Arrays.asList(new String[] {"ifname", "point", "padding"});
    }
  }
  ...
  static class Linux_C_lib_DirectMapping {
    ...
    public native int ioctl(int fd, int cmd, byte[] arg) throws LastErrorException;

    public native int ioctl(int fd, int cmd, Pointer p) throws LastErrorException;

    public native int ioctl(int fd, int cmd, WReqSocket w) throws LastErrorException;

    public native int ioctl(int fd, int cmd, WReqPoint p) throws LastErrorException;
    ...
    public native int connect(int sockfd, SockAddr sockaddr, int addrlen) throws LastErrorException;

    public native int bind(int sockfd, SockAddr sockaddr, int addrlen) throws LastErrorException;

    public native int accept(int sockfd, SockAddr rem_addr, Pointer opt) throws LastErrorException;

    public native int listen(int sockfd, int channel) throws LastErrorException;
