...
/**
 * This class provides access from Java to Linux character devices. It is intended to allow access
 * from Java to the Lego kernel modules which provide access to EV3 hardware features.
 *
 * <p>
 *
 * <p>TODO: Find a better way to return memory mapped data for use by Java.
 *
 * @author andy
 */
public class NativeDevice extends NativeFile {
  ...
  /**
   * Map a portion of the device into memory and return a pointer which can be used to read/write
   * the device.
   *
