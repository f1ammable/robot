...
public class EV3Video implements Video {
  ...
  /**
   * Open the device and make it available for use, specify the desired frame size. Note that the
   * actual frame size may be adjusted to conform to the capabilities of the device.
   *
  ...
  /**
   * Open the device and make it available for use, specify the desired frame size. Note that the
   * actual frame size may be adjusted to conform to the capabilities of the device. The format of
   * the pixel will be YUYV and the fields will be interlaced.
   *
   * @param w the desired frame width
   * @param h the desired frame height
   * @throws java.io.IOException
