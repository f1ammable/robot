...
public abstract class DBusProperties {
  ...
  public interface PropertiesAccess extends DBusInterface {
    ...
    /**
     * Returns all properties for the interface. See the properties section for available
     * properties.
     *
     * @return
     */
    ...
    /**
     * Changes the value of the specified property. Only properties that are listed a read-write are
     * changeable.
     *
     * @param name
     * @param value
  ...
  public static String getStringValue(
      Map<String, Variant<?>> properties, PropertyEnum propertyEnum) {
    if (properties == null) {
      return null;
    }
    // TODO use type annotation
  ...
  @SuppressWarnings("unchecked")
  public static boolean getBooleanValue(
      Map<String, Variant<?>> properties, PropertyEnum propertyEnum, boolean defaultValue) {
    // TODO use type annotation
