...
public interface Device extends DBusInterface, DBusProperties.PropertiesAccess {
  ...
  public static enum Properties implements DBusProperties.PropertyEnum {
    ...
    /** The Bluetooth remote name. This value can not be changed. Use the Alias property instead. */
    @DBusProperty(type = String.class, access = DBusPropertyAccessType.READONLY)
    Name,
    ...
    Paired,
    /**
     * Indicates if the remote device is currently connected. A PropertyChanged signal indicate
    ...
    /**
     * The name alias for the remote device. The alias can be used to have a different friendly name
     * for the remote device.
     *
     * <p>In case no alias is set, it will return the remote device name. Setting an empty string as
     * alias will convert it back to the remote device name.
     *
     * <p>When reseting the alias with an empty string, the emitted PropertyChanged signal will show
     * the remote name again.
     */
    ...
    Adapter,
    /**
     * Set to true if the device only supports the pre-2.1 pairing mechanism. This property is
     * useful in the Adapter.DeviceFound signal to anticipate whether legacy or simple pairing will
     * occur.
     *
     * <p>Note that this property can exhibit false-positives in the case of Bluetooth 2.1 (or
