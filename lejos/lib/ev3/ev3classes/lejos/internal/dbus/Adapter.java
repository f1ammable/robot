...
public interface Adapter extends DBusInterface, DBusProperties.PropertiesAccess {
  public static enum Properties implements DBusProperties.PropertyEnum {
    ...
    /**
     * The Bluetooth friendly name. This value can be changed and a PropertyChanged signal will be
     * emitted.
     */
    ...
    /** Switch an adapter on or off. This will also set the appropriate connectable state. */
     ...
     *
     * <p>If the DiscoverableTimeout is set to a non-zero value then the system will set this value
     * back to false after the timer expired.
     *
     * <p>In case the adapter is switched off, setting this value will fail.
     *
     * <p>When changing the Powered property the new state of this property will be updated via a
    ...
    /**
     * Switch an adapter to pairable or non-pairable. This is a global setting and should only be
     * used by the settings application.
     *
     * <p>Note that this property only affects incoming pairing requests.
     */
    @DBusProperty(type = boolean.class)
    Pairable,

    /**
     * The pairable timeout in seconds. A value of zero means that the timeout is disabled and it
     * will stay in pairable mode forever.
     */
    @DBusProperty(type = UInt32.class)
    PaireableTimeout,

    /**
     * The discoverable timeout in seconds. A value of zero means that the timeout is disabled and
     * it will stay in discoverable/limited mode forever.
     *
     * <p>The default value for the discoverable timeout should be 180 seconds (3 minutes).
     */
    @DBusProperty(type = UInt32.class)
    DiscoverableTimeout,
