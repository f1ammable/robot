...
/**
 * This class has been developed to use it in case of you have to tests leJOS programs and you need
 * to show in NXT Display data but you don't need to design a User Interface.
 *
 * <p>This class is very useful to debug algorithms in your NXT brick.
 *
...
public class DebugMessages {
  ...
  private int LCDLines =
      maximumLCDLines; // By default, Debug Messages show messages in maximumLCDLines
