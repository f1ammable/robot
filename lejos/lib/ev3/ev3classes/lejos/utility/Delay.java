...
public class Delay {
  ...
  /**
   * Wait for the specified number of microseconds. Delays the current thread for the specified
   * period of time. Can not be interrupted.
   *
  ...
  /**
   * Wait for the specified number of nanoseconds. Delays the current thread for the specified
   * period of time. Can not be interrupted.
   *
