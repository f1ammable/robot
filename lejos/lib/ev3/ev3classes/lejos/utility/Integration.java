...
/**
 * Integrate sensor measurement over time, e.g. to calculate velocity from acceleration or angle
...
public class Integration {
  ...
  /**
   * Create the integration object with the initial value for the integral value and the initial
   * reading.
   *
