...
/**
 * Factory for I2C sensor implementations. Tests what make of sensor is connected to a port and
 * creates an instance of the appropriate class for a given sensor interface.
 *
...
public class SensorSelector {
  ...
  public static SensorMode createAccelerometer(I2CPort port) throws SensorSelectorException {
    ...
    if (type.equals(HITECHNIC_ID)) return new HiTechnicAccelerometer(port).getAccelerationMode();
