...
/**
 * This class represents the local instance of an EV3 device. It can be used to obtain access to the
 * various system resources (Sensors, Motors etc.).
 *
 * @author andy
 */
public class LocalEV3 implements EV3 {
  ...
  public Port getPort(String portName) {
    for (EV3Port p : ports) if (p.getName().equals(portName)) return p;
  ...
  public Video getVideo() {
    if (video == null) video = new EV3Video();
    return video;
  }
