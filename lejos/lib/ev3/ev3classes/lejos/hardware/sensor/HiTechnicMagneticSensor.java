 ...
 * The sensor detects magnetic fields that are present around the front of the sensor in a vertical
 * orientation.
 *
 ...
 * </table>
 *
 * <p>See <a href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NMS1035">Sensor
...
public class HiTechnicMagneticSensor extends AnalogSensor implements SensorConstants {
   ...
   * The sample contains one element containing the strength of the magnetic field around the
   * sensor. The value is normalized (0-1) where 1 corresponds with the maximum field strength.
   */
