 ...
 *
 * <p>The Dexter Industries Thermal Infrared Sensor reads surface temperatures of objects. It is a
 * non-contact thermometer based on the Melexis MLX90614xCC. Detecting the infrared radiation from
 * an object, the sensor can read object temperatures between -90\u00b0F and 700\u00b0F (-70\u00b0C
 * and +380\u00b0C). The sensor has a high accuracy of 0.5\u00b0C and a resolution of 0.02\u00b0C.
 *
 * <p>The Thermal Infrared Sensor reads both the ambient temperature (the temperature of the air
 ...
 *
 * <p style="color:red;">The code for this sensor has not been tested. Please report test results to
 ...
 *
 * <p>See <a href="https://www.sparkfun.com/datasheets/Sensors/Temperature/MLX90614_rev001.pdf">
 * Sensor datasheet </a> See <a
 * href="http://www.dexterindustries.com/manual/thermal-infrared-sensor/">Sensor Product page </a>
 * See <a href="http://sourceforge.net/p/lejos/wiki/Sensor%20Framework/">The leJOS sensor
...
public class DexterThermalIRSensor extends I2CSensor {
  ...
  /**
   * Set the sensor's emissivity value. Valid values are 0.01-1.0. The emissivity is stored in
   * non-volatile memory of the sensor and will be retained even after power-off.
   *
   * <p>< 0.01 returns with no action. > 1.0 sets to 1.0
   *
   ...
   *
   * <p>Caveat Emptor: The sensor appears to only return the emissivity value after it was intially
   * set after power-up with <code>setEmissivity()</code>. It doesn't seem to retrieve it from
   * EEPROM.
   *
   ...
   * The sample contains one elements representing the surface temperature (in Kelvin) of an object.
   * the sensor can read object temperatures between -90\u00b0F and 700\u00b0F (-70\u00b0C and
   * +380\u00b0C). The sensor has a high accuracy of 0.5\u00b0C and a resolution of 0.02\u00b0C.
   *
   * <p>
   *
   * @return A sampleProvider See {@link lejos.robotics.SampleProvider leJOS conventions for
   *     SampleProviders} See <a
   *     href="https://www.sparkfun.com/datasheets/Sensors/Temperature/MLX90614_rev001.pdf">Sensor
   *     datasheet </a>
   */
   ...
   *
   * <p><b>Size and content of the sample</b><br>
   * The sample contains one elements representing the ambient temperature (in Kelvin) (the
   * temperature of the air around the sensor).
   *
   * <p>
   *
   * @return A sampleProvider See {@link lejos.robotics.SampleProvider leJOS conventions for
