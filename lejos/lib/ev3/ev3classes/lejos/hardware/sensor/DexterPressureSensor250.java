 ...
 *
 * <p>See http://www.dexterindustries.com/Products-dPressure.html.
 *
 ...
 * </table>
 *
 * <p>See <a href="http://www.dexterindustries.com/manual/dpressure/">Sensor datasheet </a> See <a
 * href="http://www.dexterindustries.com/Products-dPressure.html">Sensor Product page </a> See <a
...
public class DexterPressureSensor250 extends AnalogSensor implements SensorConstants {
   ...
   *     SampleProviders} See <a href="http://www.dexterindustries.com/manual/dpressure/">Sensor
   *     datasheet </a>
   */
  ...
  private class PressureMode implements SensorMode {
    ...
    public void fetchSample(float[] sample, int offset) {
      sample[offset] =
          (NXTRawValue(normalize(port.getPin1())) * DPRESS_MULT - DPRESS_OFFSET)
              * 1000f; // in pascals
    }
