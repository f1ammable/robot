 ...
 * The EOPD or Electro Optical Proximity Detector uses an internal light source to detect the
 ...
 * </table>
 *
 * See <a href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NEO1048">Sensor
...
public class HiTechnicEOPD extends AnalogSensor implements SensorConstants {
   ...
   * The sample contains one element containing the relative distance to a surface in the range of 0
   * to 1. Where 0 corresponds to the minimum of the measurement range and 1 corresponds to the
   * maximum of the measyurement range. The measurement range depends on the color and reflectivity
   * of the measured surface. The measurement is more or less linear to the distance for a given
   * surface.
   */
   ...
   * Measures the relative distance to a surface. This mode is suited for white objects at short
   * distance.
   *
   * <p><b>Size and content of the sample</b><br>
   * The sample contains one element containing the relative distance to a surface in the range of 0
