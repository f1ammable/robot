 ...
 *
 * <p>See <a href="http://www.dexterindustries.com/manual/dgps-2/">Sensor datasheet </a> See <a
 * href="http://www.dexterindustries.com/dGPS.html">Sensor Product page </a> See <a
...
public class DexterGPSSensor extends I2CSensor {
  ...
  public static final byte DGPS_CMD_STATUS =
      0x01; /* !< Status of satellite link: 0 no link, 1 link */
  ...
  protected void init() {
    setModes(
        new SensorMode[] {new PositionMode(), new AngleMode(), new VelocityMode(), new TimeMode()});
  }
   ...
   * The sensor uses an integer-based representation of latitude and longitude values. Assume that
   * you want to convert the value of 77 degrees, 2 minutes and 54.79 seconds to the integer-based
   * representation. The integer value is computed as follows: <code>
   * R = 1000000 * (D + M / 60 + S / 3600)</code> where <code>D=77</code>, <code>M=2</code>, and
   * <code>S=54.79</code>. For the given values, the formula yields the integer value 77048553.
   ...
   *     SampleProviders} See <a href="http://www.dexterindustries.com/manual/dgps-2/">Sensor
   *     datasheet </a>
   */
   ...
   *
   * <p><b>Size and content of the sample</b><br>
   * The sample contains one element representing the heading (in degrees) of the sensor. Accurate
   * heading information can only be given when the sensor is in motion.
   *
   * @return A sampleProvider See {@link lejos.robotics.SampleProvider leJOS conventions for
   *     SampleProviders} See <a href="http://www.dexterindustries.com/manual/dgps-2/">Sensor
   *     datasheet </a>
