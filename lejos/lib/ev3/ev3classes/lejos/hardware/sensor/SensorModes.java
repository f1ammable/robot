...
public interface SensorModes extends SensorMode {
   ...
   *
   * @param mode the index number of the mode. Index number corresponds with the item order of the
   ...
   *
   * @return the index number of the mode. Index number corresponds with the item order of the list
   *     from getAvailableModes().
   */
