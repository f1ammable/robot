 ...
 * The sensor can be powered on and off using the powerOn and powerOff methods. It is useful to
 * power off the sensor when not in use as it consumes a a fair bit of energy. <br>
 * The sensor can be tuned for a particular Sharp optical distance sensor using the setModule
 * method. See the top of the sensor for the Sharp module installed on the sensor. <br>
 * The sensor supports hardware calibration but this in not supported by this interface.
 *
 * <p>See <a
 * href="http://www.mindsensors.com/index.php?module=documents&JAS_DocumentManager_op=downloadFile&JAS_File_id=335">
 * Sensor datasheet </a> See <a
 * href="http://www.mindsensors.com/index.php?module=pagemaster&PAGE_user_op=view_page&PAGE_id=73">
...
public class MindsensorsDistanceSensorV2 extends I2CSensor {
  ...
  // Registers
  private static final int COMMAND = 0x41;
  private static final int DIST_DATA_LSB = 0x42;
  public static final int VOLT_DATA_LSB = 0x44;

  // Commands
  private static final byte DE_ENERGIZED = 0x44;
  private static final byte ENERGIZED = 0x45;
  private static final byte GP2D12 = 0x31;
  private static final byte GP2D120 = 0x32;
  private static final byte GP2Y0A21YK = 0x33;
  private static final byte GP2Y0A02YK = 0x34;
  private static final byte CUSTOM_MODULE = 0x31;
  ...
  /**
   * Returns a sample provider that measures the output level (in volt) of the sensors signal
   * processing unit.
   */
