 ...
 *
 * <p>See <a href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NBR1036">Sensor
...
public class HiTechnicBarometer extends I2CSensor {
   ...
   *
   * @param pascals the calibration value in pascals
   */
  ...
  /**
   * @return the present calibration value in pascals. Will be 0 in case no explicit calibration has
   *     been performed.
   */
