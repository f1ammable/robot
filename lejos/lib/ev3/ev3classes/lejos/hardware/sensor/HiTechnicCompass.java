 ...
 *
 * <p>See http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NMC1034
 */
 ...
 * calibration mode the sensor should be rotated slowly for making at least 1.5 full rotations. Then
 * end calibration with the endCalibration method.
 *
 * <p>See <a href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NMC1034">Sensor
 * Product page </a> See <a href="http://sourceforge.net/p/lejos/wiki/Sensor%20Framework/">The leJOS
...
public class HiTechnicCompass extends I2CSensor implements Calibrate {
  ...
  private static final byte END_CALIBRATION = 0x00; // Back to measurement mode
