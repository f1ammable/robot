 ...
 * </table>
 *
 * <p>See <a href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NGY1044">Sensor
...
public class HiTechnicGyro extends AnalogSensor implements SensorConstants {
   ...
   * The sensor measures the angular velocity in degrees per second. A positive rate indicates a
   * counterclockwise rotation. A negative rate indicates a clockwise rotation.
   *
   ...
   * The sample contains one element giving the angular speed (in degrees/second) of the sensor over
   * its vertical axis (Z-axis).
   *
   * <p>
   */
