 ...
 * The NXT IRSeeker V2 (Version 2) is a multi-element infrared detector that detects infrared
 * signals from sources such as the HiTechnic IRBall soccer ball, infrared remote controls and
 * sunlight.
 *
 ...
 * </table>
 *
 * <p>See <a href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NSK1042">Sensor
...
public class HiTechnicIRSeekerV2 extends I2CSensor {
   ...
   * The sample contains one element containing the angle to the infrared source. The angle is
   * expressed in degrees following the right hand rule.
   */
