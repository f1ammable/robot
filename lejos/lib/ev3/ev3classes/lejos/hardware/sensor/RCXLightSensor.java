...
public class RCXLightSensor extends AnalogSensor implements SensorConstants, LampController {
  ...
  /**
   * Create an RCX light sensor object attached to the specified port. The sensor will be activated,
   * i.e. the LED will be turned on.
   *
  ...
  public int getFloodlight() {
    if (this.floodlight == true) return Color.RED;
  ...
  public void setFloodlight(boolean floodlight) {
    ...
    if (floodlight == true) switchType(TYPE_REFLECTION, SWITCH_DELAY);
    else switchType(TYPE_CUSTOM, SWITCH_DELAY);
  }
