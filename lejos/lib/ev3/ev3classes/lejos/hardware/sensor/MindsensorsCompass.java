 ...
 *
 * <p>See http://www.mindsensors.com/index.php?module=pagemaster&PAGE_user_op=view_page&PAGE_id=56
 *
 * <p>author Lawrie Griffiths
 */
/**
 ...
 * The sensor can be calibrated for magnetic disturbances coming from the robot (soft iron
 * calibration). Use the startCalibration method to put the sensor in calibration mode. While in
 * calibration mode the sensor should be rotated slowly for making 2 full rotations taking at least
 * 20 seconds per turn. Then end calibration with the endCalibration method.
 *
 * <p>See <a
 ...
 * Sensor Product page </a> See <a href="http://sourceforge.net/p/lejos/wiki/Sensor%20Framework/">
 * The leJOS sensor framework</a> See {@link lejos.robotics.SampleProvider leJOS conventions for
 * SampleProviders}
 *
 * <p>
 *
...
public class MindsensorsCompass extends I2CSensor implements Calibrate {
  ...
  private static final byte BEGIN_CALIBRATION = 0x43;
  private static final byte END_CALIBRATION = 0x44;
   ...
   * The sample contains one element containing the bearing of the sensor relative to north
   * expressed in degrees. East being at 90 degrees.
   */
   ...
   * <p><b>Size and content of the sample</b><br>
   * The sample contains one element containing the bearing of the sensor relative to north
   * expressed in degrees using a right hand coordinate system in the range of (-180 to 180). West
   * being at 90 degrees, east being at -90 degrees.
   */
  ...
  /**
   * Starts calibration for the compass. Must rotate *very* slowly, taking at least 20 seconds per
   * rotation.
   *
   * <p>Should make 1.5 to 2 full rotations. Must call stopCalibration() when done.
   */
