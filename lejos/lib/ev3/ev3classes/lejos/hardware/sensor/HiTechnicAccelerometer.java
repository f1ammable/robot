 ...
 * </table>
 *
 * <p>See <a href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NAC1040">Sensor
 * Product page </a> (Some details from HTAC-driver.h from
...
public class HiTechnicAccelerometer extends I2CSensor {
   ...
   * The sample contains 3 elements, containing acceleration over the X, Y and Z axis respectively.
   * The range of the sensor is -2 to 2 G (1G = 9.81 m/s<sup>2</sup>).
   *
   * <p>
   *
   * @return A sampleProvider See {@link lejos.robotics.SampleProvider leJOS conventions for
   *     SampleProviders} See <a
   *     href="http://www.hitechnic.com/cgi-bin/commerce.cgi?preadd=action&key=NAC1040">Sensor
   *     datasheet </a>
   */
