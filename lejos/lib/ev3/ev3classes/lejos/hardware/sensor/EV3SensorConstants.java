...
public interface EV3SensorConstants {
  ...
  public static final int CONN_INPUT_DUMB =
      121; // !< Connection type is LMS2012 input device with ID resistor
  public static final int CONN_INPUT_UART = 122; // !< Connection type is LMS2012 UART sensor
  public static final int CONN_OUTPUT_DUMB =
      123; // !< Connection type is LMS2012 output device with ID resistor^
  public static final int CONN_OUTPUT_INTELLIGENT =
      124; // !< Connection type is LMS2012 output device with communication
  public static final int CONN_OUTPUT_TACHO =
      125; // !< Connection type is LMS2012 tacho motor with series ID resistance
