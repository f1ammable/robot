...
public interface SensorConstants {
  ...
  /**
   * Colors used as the output value when in full mode. Values are compatible with LEGO firmware.
   * Note that these color values are normally converted to use the standard leJOS colors as defined
   * in the Color class.
   */
