 ...
 * </table>
 *
 * <p>See <a href="http://www.minfinity.com/Manual/CruizCore_XG1300L_User_Manual.pdf">Sensor
 * datasheet </a> See <a href="http://www.minfinity.com/eng/page.php?Main=1&sub=1&tab=5">Sensor
...
public class CruizcoreGyro extends I2CSensor {
   ...
   * Sets the acc scale.
   *
   * @param sf the scale factor: 0 for +/- 2G, 1 for +/- 4G, 2 for +/- 8g
   * @throws IllegalArgumentException if the parameter is neither 0, 1, or 2.
   */
  public void setAccScale(int sf) {
    if (sf < 0 || sf > 2) throw new IllegalArgumentException();
   ...
   * The sample contains 3 elements. Each element gives linear acceleration (in metres/second^2).
   * Axis order in sample is X, Y, Z.
   *
   ...
   *     href="http://www.minfinity.com/Manual/CruizCore_XG1300L_User_Manual.pdf">Sensor datasheet
   *     </a>
   */
