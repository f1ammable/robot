...
/**
 * This class represents a Dexter Industries Laser Sensor. The sensor contains a laser and a
 * photodiode to read ambient light values. This sensor can be calibrated to low and high values.
 *
 * <p>The Dexter Industries laser can turn on and off very rapidly, with the following
 * characteristics:
 ...
 * <li>it takes about 5 ms to turn off
 *
 *     <p style="color:red;">The code for this sensor has not been tested. Please report test
 *     results to the <A href="http://www.lejos.org/forum/">leJOS forum</a>.
 *
 *     <p>
 *
 *     <table border=1>
