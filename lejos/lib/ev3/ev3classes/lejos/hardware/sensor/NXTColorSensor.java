 ...
 * allows the reading of raw color values. The sensor has a tri-color LED and this can be set to
 * output red/green/blue or off. It also has a full mode in which four samples are read
 * (off/red/green/blue) very quickly. These samples can then be combined using the calibration data
 * provided by the device to determine the "LEGO" color currently being viewed.
 *
 * <p>
 *
 * <table border=1>
 ...
 * </table>
 *
 * <p>See <a href="http://sourceforge.net/p/lejos/wiki/Sensor%20Framework/">The leJOS sensor
 ...
 * @author Andy
 */
public class NXTColorSensor extends AnalogSensor
    implements SensorConstants, LampController, ColorIdentifier {
  ...
  /**
   * get a sample provider the returns the light values (RGB + ambient) when illuminated by a white
   * light source.
   *
   * @return the sample provider
   */
  ...
  /**
   * Read the current color and return an enumeration constant. This is usually only accurate at a
