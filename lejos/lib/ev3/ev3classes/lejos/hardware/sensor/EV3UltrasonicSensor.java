 ...
 * The EV3 Ultrasonic sensor measures distance to an object in front of the sensor. It can also be
 * used to detect other (active) Ultrasonic sensors in the vicinity.
 *
 * <p>
 *
 * <table border=1>
 ...
 * The sensor can be switched off and on using the {@link #enable} and {@link #disable} methods.
 * Disabling the sensor also shuts down the lights.
 *
 * <p>See <a href="http://www.ev-3.net/en/archives/844">Sensor Product page </a> See <a
...
public class EV3UltrasonicSensor extends UARTSensor {
   ...
   * The sample contains one elements indicating the presence of another ultrasonic sensor. A value
   * of 1 indicates that the sensor detects another ultrasonic sensor.
   *
   ...
   *
   * <p><b>Size and content of the sample</b><br>
   * The sample contains one elements representing the distance (in metres) to an object in front of
   * the sensor. unit).
   *
   * @return A sampleProvider
   */
