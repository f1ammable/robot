...
public class NXTTouchSensor extends AnalogSensor implements SensorConstants {
  ...
  /**
   * Create a touch sensor object attached to the specified open port. Note this port will not be
   * configured. Any configuration od the sensor port must take place externally.
   *
