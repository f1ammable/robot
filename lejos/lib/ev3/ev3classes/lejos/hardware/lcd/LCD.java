...
public class LCD {
  ...
  /**
   * Standard two input BitBlt function with the LCD display as the destination. Supports standard
   * raster ops and overlapping images. Images are held in native leJOS/Lego format.
   *
  ...
  /**
   * Display an in on the LCD at x,y with leading spaces to occupy at least the number of characters
   * specified by the places parameter.
   *
   * @param i The value to display
  ...
  /**
   * Start the process of updating the display. This will always return immediately after starting
   * the refresh process.
   */
  ...
  /**
   * Obtain the system time when the current display refresh operation will be complete. Not that
  ...
  /**
   * Refresh the display. If auto refresh is off, this method will wait until the display refresh
   * has completed. If auto refresh is on it will return immediately.
   */
  ...
  /**
   * Provide access to the LCD display frame buffer. Allows both the firmware and Java to make
   * changes.
   *
  ...
  /**
   * Provide access to the LCD system font. Allows both the firmware and Java to share the same font
   * bitmaps.
   *
   * @return byte array that is the frame buffer.
   */
  ...
  /**
   * Set the period used to perform automatic refreshing of the display. A period of 0 disables the
   * refresh.
   *
  ...
  /**
   * Standard two input BitBlt function. Supports standard raster ops and overlapping images. Images
   * are held in native leJOS/Lego format.
   *
   * @param src byte array containing the source image
   * @param sw Width of the source image
   * @param sh Height of the source image
