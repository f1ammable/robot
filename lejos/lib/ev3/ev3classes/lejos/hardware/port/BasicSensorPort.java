...
public interface BasicSensorPort extends SensorConstants {
  ...
  /**
   * Get the current type setting. Note that types are typically used to control the operation of
   * Legacy and i2c sensors. They are normally not used for EV3 sensors.
   *
  ...
  /**
   * Set the operating type for the attached sensor. Normally type setting is only used with legacy
   * sensors and for i2c devices (to set the speed and operating voltage). It is not normally used
   * with EV3 sensors.
   *
   * @param type
