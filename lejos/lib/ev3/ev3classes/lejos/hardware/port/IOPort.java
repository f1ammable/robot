...
/**
 * Basic interface for EV3 sensor ports. TODO: Need to cleanup the setting of modes etc. should
 * probably become part of the open, with some sort of name/value string pairs.
 *
 * @author andy
 */
