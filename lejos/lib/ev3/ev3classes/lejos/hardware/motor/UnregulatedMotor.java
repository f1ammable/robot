...
public class UnregulatedMotor extends BasicMotor implements EncoderMotor {
   ...
   * @param PWMMode see {@link lejos.hardware.port.BasicMotorPort#PWM_FLOAT} and see {@link
   *     lejos.hardware.port.BasicMotorPort#PWM_BRAKE}
   */
  ...
  /**
   * Create an instance of a NXTMotor using the specified motor port the PWM operating mode will be
   * PWM_BREAK {@link lejos.hardware.port.BasicMotorPort#PWM_BRAKE}
   *
   * @param port The motor port that the motor will be attached to.
   */
