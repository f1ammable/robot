...
public abstract class BasicMotor extends Device implements DCMotor {
  ...
  /**
   * Causes motor to float. The motor will lose all power, but this is not the same as stopping. Use
   * this method if you don't want your robot to trip in abrupt turns.
   */
  public void flt() {
