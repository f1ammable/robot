...
public class Motor {
  ...
  public static final NXTRegulatedMotor A =
      new NXTRegulatedMotor(BrickFinder.getDefault().getPort("A"));

  /** Motor B. */
  public static final NXTRegulatedMotor B =
      new NXTRegulatedMotor(BrickFinder.getDefault().getPort("B"));

  /** Motor C. */
  public static final NXTRegulatedMotor C =
      new NXTRegulatedMotor(BrickFinder.getDefault().getPort("C"));

  /** Motor D. */
  public static final NXTRegulatedMotor D =
      new NXTRegulatedMotor(BrickFinder.getDefault().getPort("D"));
