 ...
 *
 * <p>RMC - NMEA has its own version of essential gps pvt (position, velocity, time) data. It is
 * called RMC, The Recommended Minimum, which will look similar to:
 *
 * <p>$GPRMC,123519,A,4807.038,N,01131.000,E,022.4,084.4,230394,003.1,W*6A
 *
 * <p>Where: RMC Recommended Minimum sentence C 123519 Fix taken at 12:35:19 UTC A Status A=active
 * or V=Void. 4807.038,N Latitude 48 deg 07.038' N 01131.000,E Longitude 11 deg 31.000' E 022.4
 * Speed over the ground in knots 084.4 Track angle in degrees True 230394 Date - 23rd of March 1994
 * 003.1,W Magnetic Variation *6A The checksum data, always begins with *
 *
...
public class RMCSentence extends NMEASentence {
   ...
   *
   * <p>$GPRMC,081836,A,3751.65,S,14507.36,E,000.0,360.0,130998,011.3,E*62
   */
