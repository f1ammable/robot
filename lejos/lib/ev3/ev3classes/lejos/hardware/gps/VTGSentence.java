 ...
 *
 * <p>eg1. $GPVTG,360.0,T,348.7,M,000.0,N,000.0,K*43 eg2. $GPVTG,054.7,T,034.4,M,005.5,N,010.2,K*41
 *
 * <p>054.7,T True course made good over ground, degrees 034.4,M Magnetic course made good over
 * ground, degrees 005.5,N Ground speed, N=Knots 010.2,K Ground speed, K=Kilometers per hour
 *
 * <p>eg3. for NMEA 0183 version 3.00 active the Mode indicator field is added at the end
 * $GPVTG,054.7,T,034.4,M,005.5,N,010.2,K,A*53 A Mode indicator (A=Autonomous, D=Differential,
...
public class VTGSentence extends NMEASentence {
   ...
   *
   * <p>$GPVTG,054.7,T,034.4,M,005.5,N,010.2,K,A*53
   */
