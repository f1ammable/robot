...
/**
 * This class manages data received from a GPS Device. GPS Class manages the following NMEA
 * Sentences:
 *
 * <p>GPRMC GPGSV GPGSA GPGGA (superclass) GPVTG (superclass)
 *
 * @author BB
...
public class GPS extends SimpleGPS {
  ...
  /**
   * Returns the number of satellites being tracked to determine the coordinates. This method
   * overwrites the superclass method and returns the number from the GSV sentence.
   *
