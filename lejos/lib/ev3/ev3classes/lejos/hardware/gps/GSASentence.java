 ...
 *
 * <p>eg1. $GPGSA,A,3,,,,,,16,18,,22,24,,,3.6,2.1,2.2*3C eg2.
 * $GPGSA,A,3,19,28,14,18,27,22,31,39,,,,,1.7,1.0,1.3*35
 *
 * <p>1 = Mode: M=Manual, forced to operate in 2D or 3D A=Automatic, 3D/2D 2 = Mode: 1=Fix not
 * available 2=2D 3=3D 3-14 = IDs of SVs used in position fix (null for unused fields) 15 = PDOP 16
 * = HDOP 17 = VDOP
 *
...
public class GSASentence extends NMEASentence {
  ...
  /**
   * Return Mode1. Mode1 can receive the following values:
   *
   * <p>M=Manual, forced to operate in 2D or 3D A=Automatic, 3D/2D
   */
  ...
  /**
   * Return Mode2. Mode1 can receive the following values:
   *
   * <p>1=Fix not available 2=2D 3=3D
   */
  ...
  public void parse(String sentence) {
    ...
    // TODO StringTokenizer must not be used to parse NMEA sentences since it doesn't return empty
    // tokens
