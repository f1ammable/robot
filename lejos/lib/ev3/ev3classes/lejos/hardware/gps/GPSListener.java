...
public interface GPSListener extends EventListener {
  ...
  /**
   * Called whenever a new NMEA sentence is produced by the GPS receiver. To identify the type of
   * NMEA sentence received, use NMEASentence.getHeader(). Then cast the sentence into the
   * appropriate type. e.g. (GGASentence)sen
   */
