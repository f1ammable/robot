...
/**
 * This class has been designed to manage the device MSC8, Mindsensors NXT Servo which manages up to
 * 8 RC Servos.
 *
 * <p>For example, do: <code>msc.servo1.setAngle(angle)</code> to set the angle of the servo at
 * location 1.
 *
 * <p>Many thanks to Luis Bunuel (bunuel66@hotmail.com) in Testing process
 *
