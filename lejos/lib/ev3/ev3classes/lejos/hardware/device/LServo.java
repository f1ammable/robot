...
/**
 * LServo, Lattebox Servo, is a abstraction to model any RC Servo (continous and non continous)
 * plugged to LSC, Lattebox Servo Controller.
 *
...
public class LServo extends LMotor {
   ...
   */
  public LServo(
      I2CPort port, int location, String servoName, byte SPI_PORT, int min_angle, int max_angle) {
    super(port, location, servoName, SPI_PORT);
