...
public class SensorMux extends I2CSensor {
  ...
  /**
   * This method return the value from a digital sensor. Currently, SMux supports Ultrasonic Sensors
   *
  ...
  /**
   * This method return the value from a analogic sensor. Currently, SMux supports Touch sensor and
   * Sound sensor
   *
   * @param channel the index of the channel
