...
public class PFMate extends I2CSensor {
  ...
  private static final int CHANNEL_REG =
      0x42; // register to control the channel the receiver is using
  private static final int MOTORS_REG = 0x43; // register for motor control
  private static final int OPER_A_REG = 0x44; // register for motor direction of motor A
  private static final int SPEED_A_REG = 0x45; // register for speed of motor A
  private static final int OPER_B_REG = 0x46; // register for motor direction of motor B
  private static final int SPEED_B_REG = 0x47; // register for speed of motor B
  ...
  /**
   * Sends command to PF IR receiver to apply changes made to the registers. Call this after You
   * have set speed, direction and/or channel.
   */
  public void update() {
