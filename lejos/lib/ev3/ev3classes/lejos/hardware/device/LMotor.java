...
/**
 * Generic abstraction to manage RC Servos and DC Motor. LServo and LDCMotor uses inherits from this
 * class
 *
...
public class LMotor extends I2CSensor {
  ...
  public static final int arrMotorUnload[] = {
    0x01, 0x02, 0x04, 0x08, 0x20, 0x40, 0x80, 0x100, 0x200
  };
  public static final int arrMotorLoad[] = {
    0x3FE, 0x3FD, 0x3FB, 0x3F7, 0x3EF, 0x3DF, 0x3BF, 0x37F, 0x2FF, 0x1FF
  };
  ...
  /**
   * private method to know internal information about if the servo is moving
   *
   * @return
   */
  ...
  /**
   * This method return current pulse over a RC Servo or a DC Motor. This method is used internally
   * by LDCMotor Objects or LServo Objects to get the speed or angle.
   *
   * @return the pulse
   */
