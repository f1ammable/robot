 ...
 * This sensor allows you to connect up to four RCX type sensors toa single port. Be aware that the
 * sensor does not track the ticks of the rotation sensor when the port is not selected.
 *
...
public class RCXSensorMultiplexer extends I2CSensor {
  ...
  private static final int CHANNEL1 = 0xfe;
  private static final int CHANNEL2 = 0xfd;
  private static final int CHANNEL3 = 0xfb;
  private static final int CHANNEL4 = 0xf7;
  private static final int ALLOFF = 0xFF;
