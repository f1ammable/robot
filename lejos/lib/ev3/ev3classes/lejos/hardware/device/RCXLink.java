...
public class RCXLink extends I2CSensor implements Opcode, IRTransmitter {
  ...
  private static final byte SLOW_SPEED = 0x44; // Default 2400 baud
  private static final byte FLUSH = 0x46; // Flush the FIFO buffer
  private static final byte HIGH_SPEED =
      0x48; // 4800 baudprivate final static byte LONG_RANGE = 0x4C;
  private static final byte SHORT_RANGE = 0x53;
  private static final byte LONG_RANGE = 0x4c;
  private static final byte TRANSMIT_RAW_MACRO = 0x55; // Transmit Unassembled raw macro data;
  private static final byte COMMAND = 0x41;
  private static final byte RUN = 0x52;
  private static final byte ARPA_ON = 0x4E;
  private static final byte ARPA_OFF = 0x4F;
  private static final byte STATUS_REG = 0x41;
  private static final byte RX_DATA_LEN = 0x40;
  private static final byte TX_DATA_LEN = 0x40;
  private static final byte RX_DATA = 0x42;
  private static final byte TX_DATA = 0x42;

  // ROM Macro Definitions:
  public static final byte SHORT_RANGE_IR = 0x01;
  public static final byte LONG_RANGE_IR = 0x04;
  public static final byte POWER_OFF_RCX = 0x07;
  public static final byte RUN_PROGRAM_1 = 0x09;
  public static final byte RUN_PROGRAM_2 = 0x0D;
  public static final byte RUN_PROGRAM_3 = 0x11;
  public static final byte RUN_PROGRAM_4 = 0x15;
  public static final byte RUN_PROGRAM_5 = 0x19;
  public static final byte STOP_ALL_PROGRAMS = 0x1D;
  public static final byte MOTOR_A_FORWARD = 0x21;
  public static final byte MOTOR_A_REVERSED = 0x25;
  public static final byte MOTOR_B_FORWARD = 0x29;
  public static final byte MOTOR_B_REVERSED = 0x2D;
  public static final byte MOTOR_C_FORWARD = 0x31;
  public static final byte MOTOR_C_REVERSED = 0x35;

  /**
   * NOTE: The BEEP macro is unreliable. It works once, and then needs another command executed
   * before it works again.
   */
  public static final byte BEEP = 0x39;

  public static final int EEPROM_BUFFER = 0x78;
