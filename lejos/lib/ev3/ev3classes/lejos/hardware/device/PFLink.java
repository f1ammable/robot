...
public class PFLink extends I2CSensor {
  ...
  public static final byte NR_RANGE_SHORT = 0x53;
  public static final byte NR_RANGE_LONG = 0x4c;

  private static final byte NR_ID = 0X02;
  private static final byte NR_COMMAND = 0X41;
  private static final byte NR_RUN = 0X52;
  private static final byte NR_SPEED_SLOW = 0X44;
  private static final byte NR_FLUSH = 0X46;
   ...
   *
   * <p>You really should call this only once for a new NRLink since it stores them in EEPROM even
   * if turned of. And I have no idea how often you can overwrite them before they burn out...
   *
   ...
   *
   * @param _Address The address of the macro, one of the MOTOR_* for a single motor or one of the
   *     COMBO_* macros which work on both motors simultaneously
   */
