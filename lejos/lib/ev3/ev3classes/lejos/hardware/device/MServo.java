...
public class MServo extends I2CSensor {
  ...
  /**
   * The initial Constructor. This constructor establish where is plugged NXTServo on NXT Brick,
   ...
   *
   * <p>Note:Pulse range is: 500-2500, but internally it is necessary to divide into 2
   *
