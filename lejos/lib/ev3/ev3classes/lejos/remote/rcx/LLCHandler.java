...
/**
 * Packet handler than implement the LLC packet protocol. Deals with packets and acks. Supports
 * independent streams of data in both directions.
 */
public class LLCHandler extends PacketHandler {
  ...
  /**
   * Search for the next packet or ack and read it into the relevant buffer and set the relevant
   * flag to say we've got it.
   */
  private void getOp() {
    for (; ; ) {
      int r = LLC.read();
