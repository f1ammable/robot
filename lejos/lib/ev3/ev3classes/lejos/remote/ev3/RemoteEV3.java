...
public class RemoteEV3 implements EV3 {
  ...
  public Port getPort(String portName) {
    for (RemotePort p : ports) if (p.getName().equals(portName)) return p;
  ...
  public RMISampleProvider createSampleProvider(
      String portName, String sensorName, String modeName) {
    try {
