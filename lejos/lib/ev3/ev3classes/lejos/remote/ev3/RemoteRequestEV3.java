...
public class RemoteRequestEV3 implements EV3, Serializable {
  ...
  public Port getPort(String portName) {
    for (RemoteRequestPort p : ports) if (p.getName().equals(portName)) return p;
  ...
  public SampleProvider createSampleProvider(
      String portName, String sensorName, String modeName, String topic, float frequency)
      throws RemoteException {
    return new RemoteRequestSampleProvider(
        is, os, portName, sensorName, modeName, topic, frequency);
  }
  ...
  public ArcRotateMoveController createPilot(
      double wheelDiameter, double trackWidth, String leftMotor, String rightMotor) {
