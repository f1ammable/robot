...
/**
 * Initiates communication to a remote NXT. Used by NXTCommand to implement the Lego Communications
 * Protocol (LCP) over Bluetooth.
 */
public class NXTComm implements NXTCommRequest {
  ...
  /**
   * Create an NXTComm object and define what type of communications it should use by specifying the
   * appropriate connector object.
   *
   * @param connector
   */
