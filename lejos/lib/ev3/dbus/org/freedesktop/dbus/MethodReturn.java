...
public class MethodReturn extends Message {
  ...
  public MethodReturn(String source, String dest, long replyserial, String sig, Object... args)
    ...
    hargs.add(
        new Object[] {
          Message.HeaderField.REPLY_SERIAL, new Object[] {ArgumentType.UINT32_STRING, replyserial}
        });
    ...
    if (null != source) {
      ...
      hargs.add(
          new Object[] {
            Message.HeaderField.SENDER, new Object[] {ArgumentType.STRING_STRING, source}
          });
    }
    ...
    if (null != dest) {
      ...
      hargs.add(
          new Object[] {
            Message.HeaderField.DESTINATION, new Object[] {ArgumentType.STRING_STRING, dest}
          });
    }
    ...
    if (null != sig) {
      hargs.add(
          new Object[] {
            Message.HeaderField.SIGNATURE, new Object[] {ArgumentType.SIGNATURE_STRING, sig}
          });
