...
public interface DBus extends DBusInterface {
  ...
  /**
   * Objects can provide introspection data via this interface and method. See the <a
  ...
  /**
   * Start a service. If the given service is not provided by any application, it will be started
   * according to the .service file for that service.
   *
  ...
  /**
   * Add a match rule. Will cause you to receive messages that aren't directed to you which match
   * this rule.
   *
  ...
  /**
   * Remove a match rule. Will cause you to stop receiving messages that aren't directed to you
   * which match this rule.
   *
   * @param matchrule The Match rule as a string. Format Undocumented.
   */
  ...
  public class NameOwnerChanged extends DBusSignal {
    ...
    public NameOwnerChanged(String path, String name, String old_owner, String new_owner)
  ...
  public interface Binding {
    ...
    public interface TestClient extends DBusInterface {
      @Description(
          "when the trigger signal is received, this method should be called on the sending"
              + " process/object.")
    ...
    public interface Tests extends DBusInterface {
      ...
      @Description(
          "Given a map of A => B, should return a map of B => a list of all the As which mapped to"
              + " B")
      ...
      @Description(
          "Given any compound type as a variant, return all the primitive types recursively"
              + " contained within as an array of variants")
