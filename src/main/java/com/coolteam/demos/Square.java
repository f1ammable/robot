...
public class Square {
    ...
    final static float DIAMETER = 51;
    final static float AXLE = 44;
    final static float ANGULAR_SPD = 100;
    final static float LINEAR_SPD = 70;
